    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View view) {
                ...
                btn_login.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        dialog.getWindow().setBackgroundDrawableResource(R.drawable.pop_up_radius);
        ...
        btn_show_dialog_with_fragment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                // myAlert.getDialog().getWindow().setBackgroundDrawableResource(R.drawable.radius_layout);
                //dialog.getWindow().setBackgroundDrawableResource(
                //R.drawable.dialog_rounded);
            }
        });
